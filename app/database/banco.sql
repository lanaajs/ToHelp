...
CREATE TABLE IF NOT EXISTS infoCuidador (
  ...
  nome_completo_cuid VARCHAR(150) DEFAULT "",
...
VALUES
  ('Alessandra', 'Bastos Pinheiro', '1161555522', '7123441', '1999-02-25', 'aleale@email.com', '123452110', 'Feminino', 'senha777', CURDATE());
  
 INSERT INTO infoCuidador (nome_cuid, sobrenome_cuid, CPF_cuid, RG_cuid, dt_nasc, email_cuid, celular_cuid, genero, senha_cuid, dt_cadastro)
VALUES
  ('Patricia', 'Oliveira', '7788990011', '4455666', '1987-03-12', 'patricia@email.com', '987654321', 'Feminino', 'senhaPQR', CURDATE()),
  ('Rafael', 'Pereira', '8899001122', '5566777', '1993-06-18', 'rafael@email.com', '987654320', 'Masculino', 'senhaRST', CURDATE()),
  ('Gabriela', 'Menezes', '9900112233', '6677888', '1982-12-05', 'gabriela@email.com', '987654319', 'Feminino', 'senhaGHI', CURDATE());
 
 
DELIMITER //
CREATE TRIGGER before_insert_infoCuidador
BEFORE INSERT ON infoCuidador
FOR EACH ROW
SET NEW.nome_completo_cuid = CONCAT(NEW.nome_cuid, ' ', NEW.sobrenome_cuid);
//
DELIMITER ;

DELIMITER //
CREATE TRIGGER before_update_infoCuidador
BEFORE UPDATE ON infoCuidador
FOR EACH ROW
SET NEW.nome_completo_cuid = CONCAT(NEW.nome_cuid, ' ', NEW.sobrenome_cuid);
//
...
VALUES
	...
	('54321-987', 'Rio de Janeiro', 'Rio de Janeiro','Laranjeiras','Rua Laranja', '456', 'Casa', 2),
    ('12345-678', 'Amazonas', 'Manaus', 'Maracipá','Av. Macapá', '758', 'Ao lado do mercado',3),
    ('12345-122', 'Bahia', 'Salvador', 'Joana Angelica','Av. Boreal', '722', 'Ao lado do mercado',4);
...
VALUES
    ('/path/rg1.png', '/path/rg2.png', '/path/curriculo1.pdf','path/certificado1.pdf','Trabalho como cuidadora a 6 anos e amo muito meu trabalho.', 1),
    ('/path/rg3.png', '/path/rg4.png', '/path/curriculo2.pdf','path/certificado1.pdf','Sou técnico em enfermagem e gosto muito de trabalhar com idosos.', 2),
    ('/path/rg3.png', '/path/rg4.png', '/path/curriculo2.pdf','path/certificado1.pdf','Fiz medicina de cuidado e técnico em enfermagem pois amo trabalhar cuidando de idosos.', 3),
    ('/path/rg3.png', '/path/rg4.png', '/path/curriculo2.pdf','path/certificado1.pdf','Trabalhei em asilos, casa de repouso e hospitais lidando com idosos todos os dias.', 4);
