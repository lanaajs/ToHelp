...
<body>
    ...
    <div class="nome_cuidador">Maria Elizangela</div>
    <div class="local">Camaçari/BA</div>

    <div class="preco">R$ 64/hr</div>
    <div class="transporte">+ Transporte</div>
    <div class="txtcuida">Como Cuidadora de Idosos, minhas qualidades profissionais são reforçadas por uma sólida
        ...
        administração de medicamentos, cuidados com a demência e habilidades de comunicação eficaz.</div>

    <div class="contato">Contato do cuidador</div>
    <div class="caixa_num">
        <div class="logo"><img src="../../public/assets/img/whats.png"></div>
    </div>
